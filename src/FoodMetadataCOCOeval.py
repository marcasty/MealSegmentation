...
class FoodCOCOEval(COCOeval):
    def __init__(self, cocoGt=None, cocoDt=None, iouType="segm"):
        ...
        if self.params.iouType == "bbox":
            self.params.confidence_key = "box_confidence"
        elif self.params.iouType == "segm":
            self.params.confidence_key = "mask_confidence"
...
if __name__ == "__main__":
    ...
    dt = FoodMetadata(
        "/me/examples/public_validation_set_release_2.1_blip2_glove_dino_sam.json"
    )
